namespace PipiModSandbox.EarlySorter
{
    ...
    {
        public const string DISPLAY_NAME = "Early Sorter";
    ...
    public class EarlySorterItem : WorldObjectItem<EarlySorterObject>
    {
    ...
    [RequireComponent(typeof(EarlySorterComponent))]
    [RequireComponent(typeof(MustBeOwnedComponent))]
    [RequireComponent(typeof(PropertyAuthComponent))]
    public class EarlySorterObject : WorldObject
    {
    ...
    public class EarlySorterComponent : WorldObjectComponent, IHasClientControlledContainers, IHasUniversalID
    {
        ...
        [SyncToView]
        [LocDisplayName("Status")]
        public string StatusMessage { get; set; } = "Pronto para processar!";

        [Interaction(InteractionTrigger.RightClick, "Executar Ação", SubComponentTypeRPCTarget = typeof(EarlySorterComponent))]
        public void DoAction(Player player, InteractionTriggerInfo trigger, InteractionTarget target, List<Tag> tagsTargetable)
        {
            this.StatusMessage = "Botão clicado em: " + WorldTime.Seconds;
        }
